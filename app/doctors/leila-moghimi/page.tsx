...
import leilaImg from '@/image/doctor-3.jpg'
    ...
    return (
        <div className='w-full h-full text-black'>
            ...
            <div className='gradient-bg h-[450px] w-full flex flex-col text-white items-center gap-5 justify-center'>
                <h1 className='text-5xl font-extrabold'>دکتر لیلا مقیمی</h1>
                <h3 className='font-light'><Link href={'/'}><span>خانه </span></Link> / دکتر ها / دکتر لیلا مقیمی</h3>
            </div>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 pb-10 gap-4 mt-10'>
                <div>
                    <div className='bg-white rounded-3xl gap-2 flex flex-col items-center p-5 '>
                        <div className='rounded-3xl shiny overflow-hidden hoverImg'><Image src={leilaImg} className='rounded-3xl duration-500' alt='doctor' /></div>
                        <div><h2 className='text-black text-xl font-bold'>دکتر لیلا مقیمی</h2></div>
                        <div><h5 className='text-black text-sm font-light text-gray-500'>جراح - دندانپزشک</h5></div>
                ...
                <div className='p-5 flex flex-col'>
                    ...
                    <div className='flex items-center mt-6 justify-around'>
                        ...
                        <div className='flex flex-col items-center'>
                            <h1 className='text-blue-500 font-extrabold text-4xl'>94%</h1>
